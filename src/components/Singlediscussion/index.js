...
class Singlediscussion extends React.Component {
    ...
    likePost = () => {
        ...
        if(this.state.formfilled == 'empty'){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/discussionlike',
                formData
            )
            .then((res) => {
            console.log(res);
    ...
    joinPost = () => {
        if(this.state.formfilled == 'empty'){
            ...
            formData.append('did', routeState.id);
            formData.append('userid', userid.value);
            axios.post('https://www.digittrix.com/staging/domaintobe/joindiscussion',
                formData
            )
            .then((res) => {
            //console.log(res);
    ...
    openLikereply = (i,id)  => {
        ...
        if(this.state.formfilled == 'empty'){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/likereplydiscussions',
                formData
            )
            .then((res) => {
            console.log(res);
    ...
    handleReplysubmit(i, e){
        ...
        if(this.state.formfilled == 'empty'){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/discussionrepliescomments',
                formData
            )
            .then((res) => {
            console.log(res);
    ...
    handleReportSubmit(event){
        ...
        if(this.state.formfilled == 'empty'){
            ...
            if(this.validates()){
                ...
                axios.post('https://www.digittrix.com/staging/domaintobe/reportdiscussion',
                    formData
                )
                .then((res) => {
                // console.log(res);
    ...
    handleReportreplySubmit(event){
        ...
        if(this.state.formfilled == 'empty'){
            ...
            if(this.validates()){
                ...
                formData.append('category', this.state.input.category);
                formData.append('description', this.state.input.description);
                axios.post('https://www.digittrix.com/staging/domaintobe/reportreplydiscussion',
                    formData
                )
                .then((res) => {
                //console.log(res);
    ...
    handlePassword(event) {
        ...
        if(this.validating()){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/handlepassword',
                formData
            ).then((res) => {
    ...
    handleSubmit(event) {
        ...
        if(this.state.formfilled == 'empty'){
            ...
            if(this.validate()){
                ...
                axios.post('https://www.digittrix.com/staging/domaintobe/replydiscussion',
                    formData
                )
                .then((res) => {
                // console.log(res);
    ...
    componentDidMount() {
        ...
        if(routeState == null){
            ...
            if(localStorage.getItem('match') == 'true'){
                ...
                formData.append('id', id);
                formData.append('userid', userid.value);
                axios.post('https://www.digittrix.com/staging/domaintobe/singlediscussion',
                        formData
                    )
                .then((res) => {
                ...
                axios.post('https://www.digittrix.com/staging/domaintobe/getreplydiscussion',
                    formData
                )
                .then((response) => {
            ...
            <div className="maindiv">
                ...
                <div className="in_center in_center_discussion">
                    <div className="main_menu ">
                        <ul>
                            <li>
                                <Link to="/userdashboard" className="active" target="_blank">
                                News Feed</Link>
                            </li>
                            <li>
                            ...
                            <div className="asuser">
                                {this.state.data.map((result) => {
                                    ...
                                    if(result.userid == userid.value){
                                        ...
                                        <div className="join" onClick={this.joinPost}>
                                ...
                                <span>
                                    ...
                                    <ul className="likecomment">
                                        <li onClick={this.likePost}><img src="/images/like.png" alt="ion"/> {this.state.postlike}</li>
                                ...
                                <div className="allcomment singlediscussionsing">
                                    {this.state.discussions.map((results, i) => {
                                        return (
                                        <div className="commentin">
                                            <span className="userimg"><img className="w-100" src={results.image} align="icon"/></span>
                                            <h5>{results.name}<a className="reportbtn" data-tag={results.id} onClick={this.openModel}  >Report</a></h5>
                                    ...
                                    {/* <div className="text-center mt-3">
                                        <a className="see_more" href="#">See more <i className="fas fa-long-arrow-alt-right"></i></a>
                                    </div> */}
                                </div>
