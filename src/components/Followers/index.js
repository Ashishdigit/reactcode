...
class Followers extends React.Component { 
    ...
    unfollow = (i,id)  => {
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/unfollow',
            formData
        )
        .then((res) => {
            console.log(res);
    ...
    render() {
        ...
        return ( 
            <section class="maindiv">
                <i class="fas fa-bars side_b"></i>
                <div class="sidbar_left">
                    <i class="fas fa-times side_b close"></i>
                    <div class="logo">
                ...
                <div class="in_center in_center_discussion">
                    <div className="main_menu ">
                        <ul>
                            <li><Link to="/userdashboard" target="_blank" className="active">News Feed</Link></li>
                            <li><Link to="/discussion" target="_blank" >Discussion</Link></li>
                            <li><Link to="/help" target="_blank">Help</Link></li> 
