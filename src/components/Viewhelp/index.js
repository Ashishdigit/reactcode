...
class Viewhelp extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if(this.validate()){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/reporthelpost',
                formData
            )
            .then((res) => {
    ...
    likePost = () => {
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/helppostlike',
            formData
        )
        .then((res) => {
        if(res.data.message == 'success')
    ...
    commentSubmit(event) {
        ...
        if(this.validates()){
            ...
            axios.post('https://www.digittrix.com/staging/domaintobe/commenthelppost',
                formData
            )
            .then((res) => {
            if(res.data.message == 'success')
    ...
    componentDidMount() {
        ...
        const formData = new FormData();
        formData.append('id', this.props.match.params.id);
        axios.post('https://www.digittrix.com/staging/domaintobe/viewsinglehelp',
            formData
        )
        .then((res) => {
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/gethelpcomments',
            formData1
        )
        .then((response) => {
    ...
    openLikereply = (i,id)  => {
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/likereplyhelp',
            formData
        )
        .then((res) => {
    ...
    handleReplysubmit(i, e){
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/relpyhelpcomments',
            formData
        )
        .then((res) => {
        if(res.data.message == 'success')
                ...
                <div className="in_center in_center_discussion">
                    ...
                    {this.state.helpposts.length > 0  ? 
                        <div className="listusr discussion help">
                            ...
                            {this.state.helpcomments.map((results, i) => {
                                return (
