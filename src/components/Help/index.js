...
class Help extends React.Component {
    ...
    handleSubmit(event) {
        ...
        if(this.state.formfilled == 'empty'){
            ...
            if(this.validate()){
                ...
                axios.post('https://www.digittrix.com/staging/domaintobe/helprequest',
                formData
                )
                .then((res) => {
    ...
    componentDidMount() { 
        document.getElementById('loadingicon').style.display = 'block';
        axios.post('https://www.digittrix.com/staging/domaintobe/gethelpposts'
        )
        .then((res) => {
            document.getElementById('loadingicon').style.display = 'none';
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/getprofessions',
        ...
        axios.get('https://www.digittrix.com/staging/domaintobe/getprofessions').then(response2 => 
        {
        ...
        axios.get('https://www.digittrix.com/staging/domaintobe/getprofessionssubcategories').then(response3 => 
        {
    ...
    handleSearch(event) {
        ...
        axios.post('https://www.digittrix.com/staging/domaintobe/searchprofessions',
            formData
        )
        .then((res) => {
