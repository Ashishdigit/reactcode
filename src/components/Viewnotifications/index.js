            ...
            <section class="maindiv">
                ...
                <div className="sidbar_left">
                    ...
                    <ul>
                        ...
                        <li><Link to="/viewnotifications" className="active" ><span><img src="images/iconS6.png" align="icon"/></span> Notifications</Link></li>
                ...
                <div className="in_center in_center_discussion">
                    <div className="main_menu ">
                        <ul>
                            <li><Link to="/userdashboard" target="_blank">News Feed</Link></li>
                            <li><Link to="/discussion" target="_blank" className="active">Discussion</Link></li>
